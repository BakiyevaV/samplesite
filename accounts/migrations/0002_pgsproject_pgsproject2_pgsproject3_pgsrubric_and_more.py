# Generated by Django 4.2.7 on 2024-02-20 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=20), size=None), size=None, verbose_name='Используемые платформы')),
            ],
        ),
        migrations.CreateModel(
            name='PGSProject2',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40, verbose_name='Название')),
                ('platform', django.contrib.postgres.fields.hstore.HStoreField(verbose_name='Используемые платформы')),
            ],
        ),
        migrations.CreateModel(
            name='PGSProject3',
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['name', 'description'], name='i_pgsrubric_name_description', opclasses=('varchar_pattern_ops', 'bpchar_pattern_ ops'))],
            },
        ),
        migrations.CreateModel(
