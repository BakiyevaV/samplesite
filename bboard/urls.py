...
from bboard.views import index, by_rubric, BbCreateView, about_us,contacts, BbDetailView,add_and_save,detail
...
urlpatterns = [
    ...
    path('/detail/int:<bb_id>/', BbDetailView.as_view(), name = 'bb_detail')
]
